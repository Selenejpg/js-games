...
function drawGameOver(){
    ...
    ctx.fillStyle = 'black';
    ctx.fillText('Game Over! Good job! Your score is ' + score, canvas.width/2 - 3, canvas.height/2 - 3)
    ctx.fillStyle = 'white';
    ctx.fillText('Game Over! Good job! Your score is ' + score, canvas.width/2, canvas.height/2)
}
